...
// Batch 10 Gap: "No QuickBooks bidirectional sync (only documented, depth unclear)" (nonai-gap) for homeServices_salesforce
// Mount path: /api/gap-no-quickbooks-bidirectional-sync-only-documented
