...
// Batch 10 page: "No competitor pricing intelligence" (ai-gap) — homeServices_salesforce
'use client';
import { useEffect, useState } from 'react';

const SLUG = "no-competitor-pricing-intelligence";
const LABEL = "No competitor pricing intelligence";
const SECTION = "ai-gap";
const API_PATH = "/api/gap-no-competitor-pricing-intelligence";

export default function NoCompetitorPricingIntelligencePage() {
