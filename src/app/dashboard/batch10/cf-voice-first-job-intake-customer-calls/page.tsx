...
// Batch 10 page: "Voice-first job intake (customer calls → AI books + sends quote)" (cfs) — homeServices_salesforce
'use client';
import { useEffect, useState } from 'react';

const SLUG = "voice-first-job-intake-customer-calls";
const LABEL = "Voice-first job intake (customer calls → AI books + sends quote)";
const SECTION = "cfs";
const API_PATH = "/api/cf-voice-first-job-intake-customer-calls";

export default function VoiceFirstJobIntakeCustomerCallsPage() {
