...
// Batch 10 page: "No post-job feedback / NPS AI agent" (ai-gap) — homeServices_salesforce
'use client';
import { useEffect, useState } from 'react';

const SLUG = "no-post-job-feedback-nps-ai";
const LABEL = "No post-job feedback / NPS AI agent";
const SECTION = "ai-gap";
const API_PATH = "/api/gap-no-post-job-feedback-nps-ai";

export default function NoPostJobFeedbackNpsAiPage() {
