...
// Batch 10 page: "CLV optimizer (upsell / cross-sell per customer based on service history)" (cfs) — homeServices_salesforce
'use client';
import { useEffect, useState } from 'react';

const SLUG = "clv-optimizer-upsell-cross-sell-per";
const LABEL = "CLV optimizer (upsell / cross-sell per customer based on service history)";
const SECTION = "cfs";
const API_PATH = "/api/cf-clv-optimizer-upsell-cross-sell-per";

export default function ClvOptimizerUpsellCrossSellPerPage() {
