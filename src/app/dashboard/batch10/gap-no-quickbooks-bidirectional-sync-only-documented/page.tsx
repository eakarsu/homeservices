...
// Batch 10 page: "No QuickBooks bidirectional sync (only documented, depth unclear)" (nonai-gap) — homeServices_salesforce
'use client';
import { useEffect, useState } from 'react';

const SLUG = "no-quickbooks-bidirectional-sync-only-documented";
const LABEL = "No QuickBooks bidirectional sync (only documented, depth unclear)";
const SECTION = "nonai-gap";
const API_PATH = "/api/gap-no-quickbooks-bidirectional-sync-only-documented";

export default function NoQuickbooksBidirectionalSyncOnlyDocumentedPage() {
